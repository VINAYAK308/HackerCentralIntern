  ...
  return (
    <nav className="flex items-center justify-between py-5 px-10 bg-black">
      ...
      <div className="flex items-center gap-4">
        <a href="/dashboard" className="bg-blue-600  text-white py-2 px-4 rounded hover:bg-purple-600 font-normal transition-all duration-300 transform hover:scale-105">
          Dashboard
        </a>
      </div>
    </nav>
